...
namespace ei2billingConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Process Board Room Charges

            SqlCommand data71Command = new SqlCommand("INSERT INTO InvoiceDetails_ei2 (TenantName, Amount, BillingMonth, BillingYear, BillingDate, TenantReferenceKey, Type, Description) (Select [Related Tenant], TotalRevenue, BillingMonth, BillingYear,[Event Date],[Related Tenant]+ BillingMonth + BillingYear, 'Hodges Room', desc1 FROM BoardRoomBilling_EI2)", dataConnection);

            data71Command.ExecuteNonQuery();
